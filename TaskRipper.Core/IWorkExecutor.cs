namespace TaskRipper.Core
{
    public interface IWorkExecutor
    {
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the action.</param>
        /// <returns>A <see cref="IWorkerResult"/> containing information about the result.</returns>
        Task<IWorkerResult> ExecuteAsync<T>(IWorkContract workContract, Action<T> action, T param, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> used to cancel the action.</param>
        /// <returns>A <see cref="IWorkerResult"/> containing information about the result.</returns>
        Task<IWorkerResult> ExecuteAsync<T1, T2>(IWorkContract workContract, Action<T1, T2> action, T1 param, T2 param2, CancellationToken cancellationToken);
        Task<IWorkerResult<TResult>> ExecuteAsync<TResult>(IWorkContract workContract, Func<TResult> func, CancellationToken cancellationToken);
        Task<IWorkerResult<TResult>> ExecuteAsync<T, TResult>(IWorkContract workContract, Func<T, TResult> func, T param, CancellationToken cancellationToken);
        Task<IWorkerResult<TResult>> ExecuteAsync<T1, T2, TResult>(IWorkContract workContract, Func<T1, T2, TResult> func, T1 param, T2 param2, CancellationToken cancellationToken);
    }
    ...
    public class WorkExecutor : IWorkExecutor
    {
        ...
        public async Task<IWorkerResult> ExecuteAsync<T>(IWorkContract workContract, Action<T> action, T param, CancellationToken cancellationToken)
        {
            return await ExecuteAsyncActionInternal(workContract, action, param, cancellationToken);
        }

        public async Task<IWorkerResult> ExecuteAsync<T1, T2>(IWorkContract workContract, Action<T1, T2> action, T1 param, T2 param2, CancellationToken cancellationToken)
        {
            return await ExecuteAsyncActionInternal(workContract, action, param, param2, cancellationToken);
        }

        public async Task<IWorkerResult<TResult>> ExecuteAsync<TResult>(IWorkContract workContract, Func<TResult> func, CancellationToken cancellationToken)
        {
            return await ExecuteAsyncFuncInternal(workContract, func, cancellationToken);
        }

        public async Task<IWorkerResult<TResult>> ExecuteAsync<T, TResult>(IWorkContract workContract, Func<T, TResult> func, T param, CancellationToken cancellationToken)
        {
            return await ExecuteAsyncFuncInternal(workContract, func, param, cancellationToken);
        }

        public async Task<IWorkerResult<TResult>> ExecuteAsync<T1, T2, TResult>(IWorkContract workContract, Func<T1, T2, TResult> func, T1 param, T2 param2, CancellationToken cancellationToken)
        {
            return await ExecuteAsyncFuncInternal(workContract, func, param, param2, cancellationToken);
        }

        private async Task<IWorkerResult> ExecuteAsyncActionInternal(IWorkContract workContract, Action action, CancellationToken cancellationToken)
        {
        ...
        private async Task<IWorkerResult> ExecuteAsyncActionInternal<T>(IWorkContract workContract, Action<T> action, T param, CancellationToken cancellationToken)
        {
            ValidateContract(workContract, action);
        ...
        private async Task<IWorkerResult> ExecuteAsyncActionInternal<T1, T2>(IWorkContract workContract, Action<T1, T2> action, T1 param, T2 param2, CancellationToken cancellationToken)
        {
            ValidateContract(workContract, action);
        ...
        private async Task<IWorkerResult<TResult>> ExecuteAsyncFuncInternal<TResult>(IWorkContract workContract, Func<TResult> func, CancellationToken cancellationToken)
        {
            ...
            var dateRange = new DateRange(startDate, endDate);
            return await Task.FromResult(new WorkerResult<TResult>(workContract, tasks.Count(), dateRange, null));
        }

        private async Task<IWorkerResult<TResult>> ExecuteAsyncFuncInternal<T, TResult>(IWorkContract workContract, Func<T, TResult> func, T param, CancellationToken cancellationToken)
        {
            ValidateContract(workContract, func);
        ...
        private async Task<IWorkerResult<TResult>> ExecuteAsyncFuncInternal<T1, T2, TResult>(IWorkContract workContract, Func<T1, T2, TResult> func, T1 param, T2 param2, CancellationToken cancellationToken)
        {
            ValidateContract(workContract, func);
